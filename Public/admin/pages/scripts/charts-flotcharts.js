    ...
    return {
        ...
        initCharts: function() {
            ...
            function chart23() {
                ...
                var pageviews = comPageviews;
                var visitors = comVisitors;

                var plot = $.plot($("#chart_23"), [{
                    data: pageviews,
                    label: "去年",
                    lines: {
                        lineWidth: 1
                ...
                $("#chart_23").bind("plothover", function(event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showTooltip(item.pageX, item.pageY, item.series.label + "" + x + "月 签单:" + y + "人 单值￥" + v[x]);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
