...
class Image {
    ...
    static function thumb($image, $thumbname, $type='', $maxWidth=200, $maxHeight=50, $interlace=true) {
        ...
        if ($info !== false) {
            ...
            $imageFun($thumbImg, $thumbname . '.'. $type);
            imagedestroy($thumbImg);
            imagedestroy($srcImg);
            return $thumbname . '.'. $type;
        }
        return false;
    }
     ...
     * @return string
     */
    static function buildImageVerify($length=5, $mode=1, $type='png', $imageL=0, $imageH=0, $verifyName='verify',$fontSize=18,$fontttf='4.ttf') {  // 验证码字体，不设置随机获取  抄袭的 onethink
